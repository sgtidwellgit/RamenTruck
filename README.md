...
**RamenTruck** is a modern machine learning and deep learning toolkit for Python, designed to simplify the complete modeling workflow—from dataset inspection and preprocessing to model training, evaluation, explainability, and experiment tracking.
...
The entry point into every workflow is **`slurp()`**.
...
`slurp()` analyzes your dataset and returns a **DatasetMenu** containing:
...
From there, RamenTruck guides the remainder of the ML pipeline.
...
| **broth** | Model training and evaluation |
...
- ✅ Intelligent preprocessing recommendations
- ✅ DatasetMenu result objects
- ✅ Comprehensive unit testing
- 🚧 Additional preprocessing modules in active development
